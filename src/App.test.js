...
describe("Rendering Components", () => {
    ...
    it("renders Notification compoent without crashing", () => {
...
describe("logic", () => {
    ...
    it("button click - update saving", () => {
        const savingsBalance = wrapper.find(".savings").text();
        const expectedValue = userBalance.savingBalance + 100 + '$';
        expect(savingsBalance).toEqual(expectedValue);
    });
